...
from backend.routes import auth_router, chat_router, patterns_router, mycelium_router, consciousness_router, neurodiversity_router, t5_router
...
app.include_router(t5_router)  # T5 E-Paper Hardware API - Funke-01744-6
